...
{
	public static var VERSION:String = '0.2.8.2'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "POWER BY PSYCH ENGINE");
